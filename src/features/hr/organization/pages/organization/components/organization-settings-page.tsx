...
import { ORGANIZATION_USER_NOTIFICATION_ITEMS } from '@/features/hr/organization/pages/_shared/constants/notification-groups';
import { NotificationToggleList } from '@/features/hr/organization/pages/_shared/components/notification-toggles-card';
    ...
    <div className="space-y-4 sm:space-y-5">
      ...
      <section className="overflow-hidden rounded-xl border border-border bg-card shadow-soft">
        ...
        <div className="space-y-5 p-4 sm:p-5">
          <div className="flex items-center justify-between gap-4 rounded-xl border border-primary/20 bg-primary/[0.04] px-4 py-3.5">
            <div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} dir="rtl" className="w-full">
            <TabsList className="flex h-auto w-full flex-wrap justify-start gap-1.5 bg-transparent p-0">
              <TabsTrigger
                value="smtp"
                className="gap-1.5 rounded-lg border border-transparent px-3 py-2 text-xs data-[state=active]:border-border data-[state=active]:bg-muted/40 sm:text-sm"
              >
