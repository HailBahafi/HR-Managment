...
} from '@/features/hr/payroll/reports/components/pdf-cash-receipt-print-html';
  ...
  const printable = React.useMemo(() => {
    ...
    return (
      <CashReceiptPrintHtml
        ...
        fields={buildCashReceiptPrintFields(previewCard, {
          employee,
          companyNameAr,
        })}
      />
  ...
  return (
    <div className="space-y-4">
      ...
      <PdfPreviewExportDialog
        ...
        title={
          previewCard
            ? `سند استلام نقدي — ${previewCard.voucherNumber}`
            : 'سند استلام نقدي'
        }
        fileName={
          previewCard
            ? `cash-receipt-${previewCard.voucherNumber}.pdf`
            : 'cash-receipt.pdf'
        }
        printable={printable}
      />
