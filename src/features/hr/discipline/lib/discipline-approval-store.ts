...
import type { HRApprovalAssignmentTemplate, HRDisciplineApprovalAssignmentLinkKind } from '@/features/hr/requests/lib/types';
import { templateStagesToCore, validateApprovalStages } from '@/features/hr/requests/lib/types';
