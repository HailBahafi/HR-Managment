...
import { MONTHLY_INPUT_KIND_LABELS } from '@/features/hr/contracts/monthly-inputs/constants/monthly-input-labels';
import type { MonthlyInputKindDto } from '@/features/hr/contracts/lib/api/monthly-inputs';
import {
