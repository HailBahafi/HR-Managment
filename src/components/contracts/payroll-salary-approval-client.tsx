...
export function PayrollSalaryApprovalClient() {
  ...
  const getEntry = usePayrollSalaryCircularStore((s) => s.getEntry);
  ...
  return (
    <div className="space-y-6">
      <SetPageTitle
        ...
        descriptionAr="متابعة إرسال كشف المستحق لكل موظف، قراءته، وموافقته على الراتب قبل إصدار مسير الرواتب — ويمكن تسجيل الحالات يدوياً حتى ربط النظام بالإشعارات الفعلية"
        iconName="UserCheck"
      />
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {previews.map((row) => {
                    ...
                    const st = getEntry(periodId, row.lineId);
                    return (
