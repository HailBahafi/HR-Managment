...
export function RosePrintPairedTwoColumnRow({
  ...
  const cell = (p: { label: string; value: string }) => (
    <div style={{ flex: '1 1 48%', minWidth: 140, fontSize: 9, color: '#334155', textAlign: 'right' }}>
  ...
  function RoseResignationRecordPrintHtml(
    ...
    return (
      ...
      >
        ...
        <RecordsDocumentLetterhead logoSrc={logoSrc} companyNameAr={companyNameAr} companyNameEn={companyNameEn} titleAr="نموذج استقالة" />
  ...
  function RoseSettlementRecordPrintHtml(
    ...
    return (
      ...
      >
        <RosePdfWatermark logoSrc={logoSrc} />
        <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', flex: 1 }}>
        <RecordsDocumentLetterhead logoSrc={logoSrc} companyNameAr={companyNameAr} companyNameEn={companyNameEn} titleAr="مخالصة نهائية" />
        ...
        <div style={{ marginTop: 10, fontSize: 10, fontWeight: 700, color: C.primary, textAlign: 'right', borderInlineStart: `3px solid ${C.gold}`, paddingInlineStart: 6 }}>
          إقرار الموظف
        </div>
        <p style={{ marginTop: 8, fontSize: 10.5, lineHeight: 1.55, textAlign: 'right', color: '#1e293b' }}>
  ...
  function RoseExperienceRecordPrintHtml(
    ...
    return (
      ...
      >
        <RosePdfWatermark logoSrc={logoSrc} />
        <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', flex: 1 }}>
        <RecordsDocumentLetterhead logoSrc={logoSrc} companyNameAr={companyNameAr} companyNameEn={companyNameEn} titleAr="شهادة خبرة" />
