  ...
  function RoseFinalSettlementFormPrintHtml(
    ...
    return (
      <div ref={ref} dir="rtl" lang="ar" style={PAGE_STYLE}>
        ...
        <p style={{ fontSize: 10.5, lineHeight: 1.85, textAlign: 'right', marginTop: 8 }}>
        ...
        >
          ...
          >
            <div style={{ width: '28%', borderInlineEnd: '1px solid #111', padding: '6px 8px', fontWeight: 700, textAlign: 'right', fontSize: 9.5 }}>
              الاسم
            </div>
            <div style={{ flex: 1, padding: '6px 8px', textAlign: 'right', fontSize: 9.5 }}>
  ...
  function RoseExperienceCertificatePrintHtml(
    ...
    return (
      <div ref={ref} dir="rtl" lang="ar" style={PAGE_STYLE}>
        ...
        {/* Title */}
        <div style={{ fontSize: 16, fontWeight: 700, textAlign: 'center', marginBottom: 16, textDecoration: 'underline' }}>
          شهادة خبرة
        </div>
