    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          type="button"
          className={cn(
            'flex h-8 max-w-[10rem] shrink-0 items-center gap-1.5 rounded-lg border px-2.5 text-xs font-medium transition-all',
      ...
      >
        ...
        <button
          ...
          className={cn(
            ...
            allSelected ? 'font-medium text-primary' : 'text-muted-foreground',
          )}
        >
          <span className={cn(
