...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      'peer relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center overflow-hidden rounded-full border border-border/60 bg-muted/50 p-0.5 shadow-[inset_0_1px_2px_rgba(0,0,0,0.04)] transition duration-200 ease-out',
      ...
      'data-[state=checked]:border-primary/25 data-[state=checked]:bg-primary/15 data-[state=checked]:shadow-[inset_0_1px_0_rgba(255,255,255,0.35)]',
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        'data-[state=checked]:border-primary/20 data-[state=checked]:bg-primary data-[state=checked]:shadow-[0_1px_4px_rgba(0,0,0,0.12)]',
      )}
    />
  </SwitchPrimitives.Root>
));
