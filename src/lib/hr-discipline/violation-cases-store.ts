...
const SEED: HRViolationCaseRecord[] = [
  ...
  {
    id:'case-e1-2', caseNumber:'VIO-2026-0002',
    employeeId:'e1', employeeNameAr:'عبدالرحمن المالكي', employeeNameEn:'Abdulrahman Al-Malki',
    date:'2026-02-23', description:'تأخر 60 دقيقة عن موعد الدوام مع عدم الإبلاغ المسبق', notes:'تكرار لمخالفة سابقة في يناير', attachmentsNote:'',
    violationTypeId:'vt-1', typeCode:'LATE', typeNameAr:'التأخر عن العمل',
    typeHasDeduction:true, typeDeductionKind:'hours', typeDeductionValue:1,
    typeNeedsWarning:true, typeNeedsInvestigation:false, typeNeedsApproval:false,
    approvalTemplateId:null, status:'executed', requiredApprovers:[], currentApprovalIndex:0,
    approvalLog:[], postedToPayroll:true, createdAt:'2026-02-23T09:00:00Z', updatedAt:'2026-02-24T10:00:00Z',
  },
  {
    id:'case-e1-3', caseNumber:'VIO-2026-0005',
    employeeId:'e1', employeeNameAr:'عبدالرحمن المالكي', employeeNameEn:'Abdulrahman Al-Malki',
    date:'2026-01-12', description:'الغياب يوم كامل بدون إذن مسبق', notes:'لم يُقدّم أي مسوّغ', attachmentsNote:'',
    ...
    typeNeedsWarning:true, typeNeedsInvestigation:false, typeNeedsApproval:false,
    approvalTemplateId:null, status:'approved', requiredApprovers:[], currentApprovalIndex:0,
    approvalLog:[], postedToPayroll:true, createdAt:'2026-01-12T09:00:00Z', updatedAt:'2026-01-13T08:00:00Z',
  },
  {
    id:'case-e1-4', caseNumber:'VIO-2026-0009',
    employeeId:'e1', employeeNameAr:'عبدالرحمن المالكي', employeeNameEn:'Abdulrahman Al-Malki',
    date:'2026-03-25', description:'تغيب بدون إذن وعدم الاستجابة للاتصالات الرسمية', notes:'المشرف أبلغ عن صعوبة في التواصل', attachmentsNote:'',
    violationTypeId:'vt-4', typeCode:'ABS_NX', typeNameAr:'الغياب بدون إذن',
    typeHasDeduction:true, typeDeductionKind:'day', typeDeductionValue:1,
    ...
    approvalLog:[
      { role:'manager', action:'approved', note:'الغياب موثق في سجل الحضور', at:'2026-03-26T08:00:00Z' },
    ],
    postedToPayroll:false, createdAt:'2026-03-25T10:00:00Z', updatedAt:'2026-03-26T08:00:00Z',
  },
  {
...
export const useHRViolationCasesStore = create<CasesState>()(
  persist(
    ...
    { name:'hr_discipline_cases_v1', storage: createJSONStorage(() => localStorage), version:5, migrate: () => ({ cases: SEED, _seq: 35 }) },
  ),
);
